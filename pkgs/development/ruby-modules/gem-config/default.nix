...
, pkgconfig , ncurses, xapian, gpgme, utillinuxMinimal, tzdata, icu, libffi
...

{
  ...
  gio2 = attrs: {
    nativeBuildInputs = [ pkgconfig ];
    buildInputs = [ gtk2 pcre gobject-introspection ] ++ lib.optionals stdenv.isLinux [ utillinuxMinimal libselinux libsepol ];
  };
  ...
  gtk2 = attrs: {
    nativeBuildInputs = [
      ...
      utillinuxMinimal libselinux libsepol
    ];
